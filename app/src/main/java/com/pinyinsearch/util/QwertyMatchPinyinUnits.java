...
public class QwertyMatchPinyinUnits
{
	 ...
	 */
	@SuppressLint("DefaultLocale")
	public static boolean matchPinyinUnits(final List<PinyinUnit> pinyinUnits, final String baseData, String search, StringBuilder chineseKeyWord)
	{
		if ((null == pinyinUnits) || (null == search) || (null == chineseKeyWord))
		{
			return false;
		}
		StringBuilder matchSearch = new StringBuilder();
	 ...
	 */
	private static boolean findPinyinUnits(final List<PinyinUnit> pinyinUnits, int pinyinUnitIndex, int qwertyPinyinUnitIndex, final String baseData, StringBuilder searchBuffer, StringBuilder chineseKeyWord)
	{
