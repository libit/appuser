...
public class DialogSettingColumnPortrait extends Dialog implements OnClickListener, SeekBar.OnSeekBarChangeListener
{
	...
	public DialogSettingColumnPortrait(Context context, DialogListenser listenser)
	{
	...
	private void initView()
	{
		...
		tvTitle.setText(R.string.dialog_title_setting_column_portrait);
		...
		textCount = PreferenceUtils.getInstance().getIntegerValue(PreferenceUtils.APP_COLUMN_COUNT_PORTRAIT);
	...
	public void onClick(View v)
	{
		switch (v.getId())
		{
			...
			{
				PreferenceUtils.getInstance().setStringValue(PreferenceUtils.APP_COLUMN_COUNT_PORTRAIT, textCount + "");
				if (listenser != null)
				{
					listenser.onOkClick();
				}
