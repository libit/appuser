 ...
 */
public class ChooseAppListAdapter extends BaseUserAdapter<AppInfo>
{
	public interface IChooseAppListAdapterItemClicked
	{
	...
	private final IChooseAppListAdapterItemClicked iChooseAppListAdapterItemClicked;

	public ChooseAppListAdapter(Context context, List<AppInfo> appInfoList, IChooseAppListAdapterItemClicked iChooseAppListAdapterItemClicked)
	{
		super(context, appInfoList);
		this.iChooseAppListAdapterItemClicked = iChooseAppListAdapterItemClicked;
		// 初始化缓存大小
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (appInfo.getId().contains("/"))
		{
			tvType.setText("路径：" + appInfo.getId());
		}
		else
		{
		...
		cbBlack.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
		{
			...
			{
				if (iChooseAppListAdapterItemClicked != null)
				{
					iChooseAppListAdapterItemClicked.onCheckedClicked(appInfo, isChecked);
				}
			}
		});
		tvTips.setText("");
